...
import { AdditionalDetailsCard, getAdditionalDetails, LivestockCard } from "./livestock-card";
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              {/* Timeline */}
              <RecordTimeline createdAt={data.createdAt} recordDate={data.recordDate} updatedAt={data.updatedAt} />

...
export function ActionButtons<T>({
	...
	deleteDescription = "This action cannot be undone. Are you sure you want to permanently delete this record from our servers?",
	...
	return (
		<div className={className}>
			...
			{/* Delete */}
			{showDelete && confirmDelete && onDelete && (
				<DeleteDialogue
					title={deleteTitle}
